...
* **Conexão com o Roadmap:**
  ...
  * **Sucesso Recente (BSTW 2025):** A prova da Conjectura Principal para primos supersingulares (usando *Signed Selmer Groups*) fecha a lacuna final. Isso mostra que, se tivermos "largura de banda infinita" (a função p-ádica inteira), a informação aritmética é preservada.
