...
| :--- | :--- | :--- | :--- |
| **LHC (CERN)** | Seção Transversal Total ($\sigma_{tot}$) | **~110 mb @ 13 TeV** | ![Alinhado](https://img.shields.io/badge/Alinhado-Desvio_<5%25-brightgreen) |
| **IXPE (NASA)** | Birrefringência do Vácuo | **PD ~13.5% (Magnetar)** | ![Validado](https://img.shields.io/badge/Validado-v2_Quadrático-brightgreen) |
| **Fermi-LAT** | Invariância de Lorentz | **$\xi < 0.065$** (Limitado) | ![Limitado](https://img.shields.io/badge/Limitado-Não_Falsificado-blue) |
| **Kernel HPC** | Convergência Métrica | **Escala 1/sqrt(N)** | ![Robusto](https://img.shields.io/badge/Robusto-Métrica_Estável-success) |
