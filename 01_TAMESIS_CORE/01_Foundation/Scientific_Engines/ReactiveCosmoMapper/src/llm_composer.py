"""
LLM Composer - TAMESIS Symphony
Uses OpenRouter API to compose Minimalist Piano sheet music based on TAMESIS Harmony.
"""
import requests
import json
import os
...
def compose_partiture():
    print("🤖 Contacting the Cosmic Composer (OpenRouter)...")
    
    # The Prompt - Defining the "TAMESIS Mode"
    prompt = """
    You are a Neoclassical Composer (like Erik Satie or Philip Glass).
    Compose a short PIANO piece called "The TAMESIS Resonance".
...
def generate_html(abc_code):
    ...
    <head>
        <meta charset="utf-8">
        <title>TAMESIS Symphony: The Resonance</title>
...
if __name__ == "__main__":
    ...
    if abc_data:
        ...
        print("⚠️ Using Deterministic Backup Score...")
        backup_abc = """X:1
T:The TAMESIS Resonance (Backup)
C:TAMESIS AI
M:4/4
L:1/8
Q:1/4=60
...
| "Am"A,,8 |]"""
        ...
        with open(output_path, "w") as f:
            f.write(html_content)
        print(f"✅ Backup HTML Generated: {output_path}")
