...
**Última atualização:** 2026-08-21 (`DISC-DEC-014`: onda 1 de `DISC-CORE-NUMERICS-001` integrada — `M_c` INCONSISTENTE, quarks/nós NÃO SOBREVIVE, constantes NENHUMA sobrevive, U₁/₂ PARCIALMENTE SOBREVIVE com reprodução adversarial completa [expoente 1/2 e distinção de classe confirmados; "teorema" de limite exato refutado; objeto-limite identificado]; triagem RH 5/6/10 concluída [item 10 FHK priorizado]. Onda 2 despachada: caracterização da função-limite U₁/₂ + pré-registro FHK. `DISC-TRI-RG-001` permanece `CLOSED_NULL`)
