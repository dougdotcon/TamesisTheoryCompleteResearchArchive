...
def validate() -> dict[str, Any]:
    ...
    monovariant_dependency = item_by_id.get("FOUND-INVARIANT-UNREACHABILITY-001", {})
    if active == "FOUND-MONOVARIANT-DESCENT-001" and (
        monovariant_dependency.get("status") != "VERIFIED"
        or monovariant_dependency.get("result_review") != "APPROVED"
    ):
        errors.append(
            "FOUND-MONOVARIANT-DESCENT-001 cannot be active before "
            "FOUND-INVARIANT-UNREACHABILITY-001 is VERIFIED with result_review APPROVED"
        )
    ...
    if active not in {"LAB-BENCH-001", "FOUND-SEMIGROUP-001", "RH-NOGO-001",
                      ...
                      "WAVE3-BATCH-001",
                      "WAVE3-RH-3", "WAVE3-NS-3A",
                      "WAVE3-PN-6", "WAVE3-PN-7",
                      "WAVE3-YM-STABILITY-COMPOSE", "WAVE3-YM-STABILITY-GROUNDED",
                      "WAVE3-HG-1C", "WAVE3-HG-1D", "WAVE3-HG-4C",
                      "WAVE3-BSD-1-STEP3-HASEXTENSION", "WAVE3-BSD-1-STEP4-RESIDUE-BIJECTION",
                      "WAVE3-TOE-3D", "WAVE3-TOE-3E",
                      "WAVE3-QF-6",
                      "WAVE3-SHARED-2A-EXT",
                      "WAVE4-BATCH-001",
                      "WAVE4-RH-4", "WAVE4-RH-5",
                      "WAVE4-NS-4A",
                      "WAVE4-PN-8",
                      "WAVE4-YM-CAPSTONE-BRACKET", "WAVE4-YM-CAPSTONE-FULL",
                      "WAVE4-HG-1E", "WAVE4-HG-1F", "WAVE4-HG-4D",
                      "WAVE4-BSD-1-STEP5-COMPOSE",
                      "WAVE4-TOE-4",
                      "WAVE4-QF-7",
                      "WAVE4-SHARED-4A", "WAVE4-SHARED-4B",
                      "WAVE5-BATCH-001",
                      "WAVE5-RH-6A", "WAVE5-RH-6B", "WAVE5-RH-6C",
                      "WAVE5-NS-5A",
                      "WAVE5-YM-CAPSTONE-DET-BRACKET", "WAVE5-YM-CAPSTONE-EIGVAL-DICHOTOMY",
                      "WAVE5-HG-4E", "WAVE5-HG-1G", "WAVE5-HG-4F",
                      "WAVE5-BSD-6",
                      "WAVE5-TOE-5",
                      "WAVE5-QF-8", "WAVE5-QF-9",
                      "WAVE5-SHARED-5A",
                      "WAVE6-BATCH-001",
                      "WAVE6-RH-7A", "WAVE6-RH-7B",
                      "WAVE6-NS-6A",
                      "WAVE6-YM-CAPSTONE-TRACE-M1-EXACT", "WAVE6-YM-CAPSTONE-DET-BRACKET-TIGHTENED",
                      "WAVE6-HG-1H", "WAVE6-HG-4G",
                      "WAVE6-BSD-7",
                      "WAVE6-TOE-6A", "WAVE6-TOE-6B",
                      "WAVE6-QF-10", "WAVE6-QF-11",
                      "WAVE6-SHARED-6A",
                      "WAVE7-BATCH-001",
                      "WAVE7-RH-7C", "WAVE7-RH-7D",
                      "WAVE7-NS-7A",
                      "WAVE7-YM-CAPSTONE-DET-M1-EXACT", "WAVE7-YM-CAPSTONE-LAMBDAMAX-M1-QUADRATIC-EXACT", "WAVE7-YM-CAPSTONE-EIGVAL-DICHOTOMY-TIGHTENED",
                      "WAVE7-HG-4H", "WAVE7-HG-1I",
                      "WAVE7-BSD-8",
                      "WAVE7-TOE-7",
                      "WAVE7-QF-12", "WAVE7-QF-13",
                      "WAVE7-SHARED-7A"}:
        errors.append(
    ...
    if state.get("authorized_action") not in {
        ...
        "FOUND_INVARIANT_UNREACHABILITY_001_RESULT_REVIEW_AUTHORIZED",
        "FOUND_MONOVARIANT_DESCENT_001_SPECIFICATION_PREPARATION_AUTHORIZED",
        "FOUND_MONOVARIANT_DESCENT_001_SPECIFICATION_REVIEW_AUTHORIZED",
        "FOUND_MONOVARIANT_DESCENT_001_FORMALIZATION_AUTHORIZED",
        "FOUND_MONOVARIANT_DESCENT_001_RESULT_REVIEW_AUTHORIZED",
        "LAB_CORR_MONOVARIANT_VACUITY_CORRECTION_AUTHORIZED",
        "FOUND_COMPUTABILITY_BRIDGE_001_SPECIFICATION_PREPARATION_AUTHORIZED",
        ...
        "FOUND_UNIFORM_PRIMREC_001_SPECIFICATION_REVIEW_AUTHORIZED",
        "FOUND_UNIFORM_PRIMREC_001_FORMALIZATION_AUTHORIZED",
        "FOUND_UNIFORM_PRIMREC_001_RESULT_REVIEW_AUTHORIZED",
        "ENG_RUNTIME_SOUNDNESS_002_SPECIFICATION_PREPARATION_AUTHORIZED",
