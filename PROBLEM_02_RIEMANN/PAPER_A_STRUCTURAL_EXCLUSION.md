...
*Proof Sketch:* Any off-axis eigenvalue induces local clustering correlations that violate the Definition 1.3 (Spectral Rigidity) required for membership in $\mathcal{C}_{crit}$.
