...
|---:|---|---:|---|---|
| 🥇 | **D — `U₁/₂`** (subconjunto adjudicado, `DISC-CORE-NUMERICS-001`) | **~90%** | ✅ Lema Aberto e conjectura de taxa para `K` geral provados **incondicionalmente para todo `K≥0`** (2026-08-22) — a questão central em aberto da linha principal está fechada | Restante, nenhum central: a forma fechada exata em todas as ordens para `K` geral; o resíduo M-CLUST(b) (um mecanismo separado, `PARTIALLY CLOSED`); a lei distribucional completa (Conjecturas 1–2) — ver [mapa de dependência](05_DISCOVERY_LAB/02_TESTS/CORE_NUMERICS/u12_universality/PROOF_DEPENDENCY_MAP.md) |
