...
This document details the architecture of the legacy Python simulation engine found in the `src/` directory. This engine was used for the initial "TAMESIS Universe" simulations and hypothesis testing before the Phase 1-3 MCMC validation.
...
- **Hypotheses Tested:**
    ...
    2. TAMESIS Metric (Quantum Compression).
