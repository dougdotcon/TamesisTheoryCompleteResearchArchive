...
1. **Exact Diagonalization** (Small N) to find the Gap $\Delta$. We use a **Sherrington-Kirkpatrick Spin Glass model with Random Fields** ($H = -\sum J_{ij}\sigma_i\sigma_j - \sum h_i \sigma_i$) to mimic the lack of symmetry in random 3-SAT.
...
* This confirms the "Exponential Gap Closure" (Lemma 3.1).

![Spectral Gap Scaling](p_vs_np_simulation_results.png)
