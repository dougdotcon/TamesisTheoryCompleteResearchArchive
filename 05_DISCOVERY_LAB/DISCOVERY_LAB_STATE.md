...
**Última atualização:** 2026-08-20 (fechamento de `largest_lyapunov_exponent`, `DISC-TRI-RG-001` — 13º candidato da linha sem invariante cross-domain sobrevivente; fechado na etapa de validação, mesma parede estrutural de embedding FNN que já fechou `RQA`, dado real nunca tocado)
...
| Próxima ação obrigatória | Nenhuma obrigatória. `DISC-TRI-RG-001`: Fase 0.7 tem 2/3 candidatos fechados (`complexidade-de-lempel-ziv`, NEGATIVO após reexecução adversarial; `largest_lyapunov_exponent`, fechado na validação). Resta 1 candidato formalizado `viable=true` ainda não travado: DMD/espectro de Koopman [rank 3] — herda o MESMO risco de embedding Hankel/Takens que já fechou 2 candidatos consecutivos na validação nesta linha (RQA, LLE), checagem de controle positivo obrigatória antes de qualquer dado real. Aguardando escolha do usuário sobre fechar DMD/Koopman em seguida, ou considerar a linha suficientemente explorada por ora (13/13 candidatos identificados com resultado final, nenhum invariante sobrevivente); status permanece `CANDIDATE_FORMULATING`. Ver `02_TESTS/TRI_RG/phase0/PHASE0_7_SURVEY_NEW_CANDIDATES.md` e `02_TESTS/TRI_RG/largest_lyapunov_exponent/RESULTS_SUMMARY.md` |
| Decisões de governança | `DISC-DEC-001` (criação da trilha), `DISC-DEC-002` (fechamento do piloto), `DISC-DEC-003` (arquitetura de três motores + seis extensões), `DISC-DEC-004` (pivô de SPARC-002 + pré-registro do teste de derivação de a₀), `DISC-DEC-005` (1ª pausa de `DISC-TRI-RG-001`, revertida em 2026-08-14), `DISC-DEC-006` (2ª pausa, revertida em 2026-08-15), `DISC-DEC-007` (3ª pausa, revertida em 2026-08-18), `DISC-DEC-008` (4ª pausa de `DISC-TRI-RG-001` a pedido do usuário, 2026-08-20, após os 11/11 candidatos identificados na linha resultarem sem invariante cross-domain sobrevivente) |
