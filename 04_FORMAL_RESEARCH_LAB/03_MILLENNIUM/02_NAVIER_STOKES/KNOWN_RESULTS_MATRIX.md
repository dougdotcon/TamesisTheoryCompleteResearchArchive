...
| 9 | Solução exata da Euler restrita | Cantwell, 1992 | *Phys. Fluids A* 4, 782–793 | Forma fechada (funções elípticas de Jacobi) da dinâmica de Vieillefosse; geometria assintótica do gradiente de velocidade quase independente da condição inicial | **verificado** (WebSearch, citação e conteúdo recuperados) |
