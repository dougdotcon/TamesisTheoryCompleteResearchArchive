"""
COPIA com atribuicao -- DISC-RH-FHK-SHORT-INTERVAL-MAX-001 (onda 2, DISC-DEC-014).
Fonte: ../phase0_zeta_eval_triage/rs_zeta.py (motor Riemann-Siegel validado em
2026-08-21 contra mpmath e zeros de Odlyzko -- validation_zeta_eval.{log,json},
com registro de falha preservado em validation_zeta_eval_run1_FAILED.log).
Copiado byte a byte abaixo desta docstring de atribuicao; NENHUMA alteracao
de codigo. Dominio validado: t em [2000, 1e11], tolerancias por faixa (ver
TRIAGE_NOTE.md, adendo).
"""
"""
