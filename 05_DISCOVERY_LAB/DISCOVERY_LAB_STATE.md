...
**Última atualização:** 2026-08-22 (`DISC-DEC-020`: correção de rigor de `M-CLUST(b)` integrada — 2 erros reais encontrados na fórmula finito-n original, corrigidos parcialmente [fecha 70-86% do gap, resíduo caracterizado e não escondido]; classificação assintótica U₁/₂ não afetada. Revisão dos itens não-tentados de `DISC-RH-REAL-001` concluída — item 12 [variância do número/rigidez GUE] identificado como candidato genuíno, itens 4/11 marcados `NÃO TRIÁVEL` [buraco de proveniência honesto]; pré-registro completo `DISC-RH-NUMBER-VARIANCE-001` em execução)
